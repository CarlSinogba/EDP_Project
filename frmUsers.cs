...
namespace EDP_WinProject1
{
    public partial class frmUsers : Form
    {
        ...
        private void btnUpdateUserProfile_Click_1(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(txtPasswordUpdate.Text) ||
                string.IsNullOrWhiteSpace(txtEmailUpdate.Text))
            {
                MessageBox.Show("Please fill in all fields.", "Incomplete data", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            var confirm = MessageBox.Show("Are you sure you want to update this user?","Confirm Update", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
